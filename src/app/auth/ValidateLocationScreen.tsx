    ...
    >
      ...
      <View style={tw`w-11/12 mt-4`}>
        <AuthStaticButton
          ...
          loading={loading}
          color={
            granted ? '#16A34A' : requested ? '#FFD700' : colors.brand.secondary
          }
          valid={granted || false}
        />
      </View>
      ...
      <View style={tw`w-11/12 mt-auto mb-6`}>
        <Text style={[tw`text-xs text-center`, { color: colors.muted }]}>
          You can change this anytime in Settings. Movaro uses location only for
          business operations while you’re on shift.
        </Text>
      </View>
    </View>
  );
