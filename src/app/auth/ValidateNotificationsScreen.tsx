...
import { requestNotificationPermission } from '../../shared/lib/PushNotificationService';
...
const ValidateNotificationsScreen = () => {
  ...
  const handleAppStateChange = (nextAppState: AppStateStatus) => {
    // If the app is coming back to the foreground ('active'), re-check permissions
  ...
  useEffect(() => {
    // 1. Initial request/check on mount
    handleRequestNotifications();

    // 2. Set up AppState listener for foreground events
